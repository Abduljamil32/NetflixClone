...
class TitlePreviewViewController: UIViewController {
    ...
    private let overviewLabel: UILabel = {
        ...
        label.text = "Movies alfbeowbwonfeonwqovannvmqovpqboaba"
        return label
...
//        avpController.view.frame.size.width = webView.frame.size.width
//        avpController.view.frame.size.height = webView.frame.size.height
//        self.webView.addSubview(avpController.view)
//        player.play()
    }
